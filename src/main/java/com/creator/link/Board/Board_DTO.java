...
public class Board_DTO {
	...
	public Board_DTO(int bct_content_number, String bct_writer, String bct_title, String bct_content, String bct_write_date, int bct_view_cnt, int bct_like_cnt, int bat_number, int mb_number) {
