...
function addOptionCategory() { // 옵션 카테고리 추가
    ...
    div.className = 'optionCategory'; // 태그 클래스 명
    ...
    div.className = 'option'+optionCategoryCount;
...
function addOption1() { // 옵션 생성
    ...
    div.className = 'option1'; // 옵션 태그 클래스명 설정
    ...
    div.innerHTML = option1Count +'옵션 이름: <input type="text" id="os_'+ option1Count +'name" name="os_'+ option1Count +'name" >' + 
				    ...
				    option1Count +'옵션 재고: <input type="number" min="0"	id="os_'+ option1Count +'stock" name="os_'+ option1Count +'stock" onchange="tot_stock()" class="stock">';
...
function addOption2() { // 2번 옵션 카테고리에 옵션 생성 함수
    ...
    div.innerHTML = option2Count +'옵션 이름: <input type="text" id="os_'+ option2Count +'name" name="os_'+ option2Count +'name" >' + 
				    ...
				    option2Count +'옵션 재고: <input type="number" min="0"	id="os_'+ option2Count +'stock" name="os_'+ option2Count +'stock" onchange="tot_stock()" class="stock">' ;
...
function addOption3() {// 3번 옵션 카테고리에 옵션 생성 함수
    ...
    div.innerHTML = option3Count +'옵션 이름: <input type="text" id="os_'+ option3Count +'name" name="os_'+ option3Count +'name" >' + 
				    ...
				    option3Count +'옵션 재고: <input type="number" min="0"	id="os_'+ option3Count +'stock" name="os_'+ option3Count +'stock" onchange="tot_stock()" class="stock">' ;
	var deleteButton = document.createElement('input');
    deleteButton.type = "button";
    deleteButton.value = '마지막 옵션 제거';
    deleteButton.onclick = function() {
